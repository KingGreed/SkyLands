...
namespace Game.CharacSystem
{
    public static class JumpSpeed
    {
        ...
        private static Timer mTimeOfJump = new Timer();
        ...
        public static void Jump() { mTimeOfJump.Reset(); }

        private static float GetSec(){ return (float)mTimeOfJump.Milliseconds / 1000f; }
    }
}
