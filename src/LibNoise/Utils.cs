...
namespace LibNoise
{
    public static class Utils {
	    ...
	    public static double[] LatLonToXYZ(double latitude, double longitude) {
		    double r = MathHelper.cos(ToRadians(latitude));
		    double x = r * MathHelper.cos(ToRadians(longitude));
		    double y = MathHelper.sin(ToRadians(latitude));
		    double z = r * MathHelper.sin(ToRadians(longitude));
