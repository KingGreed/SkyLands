...
namespace LibNoise.Modules.Combiner
{
    public class Select : Module {
	    ...
	    public const double DEFAULT_SELECT_EDGE_FALLOFF = 0.0;

	    /// Default lower bound of the selection range for the
	    /// noise::module::Select noise module.
	    public const double DEFAULT_SELECT_LOWER_BOUND = -1.0;

	    /// Default upper bound of the selection range for the
	    /// noise::module::Select noise module.
	    public const double DEFAULT_SELECT_UPPER_BOUND = 1.0;
