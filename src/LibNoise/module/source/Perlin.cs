...
namespace LibNoise.Modules.Source
{
    ...
    public class Perlin : Module {
	    ...
	    public static readonly double DEFAULT_PERLIN_FREQUENCY = 1.0;

	    /// Default lacunarity for the noise::module::Perlin noise module.
	    public static readonly double DEFAULT_PERLIN_LACUNARITY = 2.0;

	    /// Default number of octaves for the noise::module::Perlin noise module.
	    public static readonly int DEFAULT_PERLIN_OCTAVE_COUNT = 6;

	    /// Default persistence value for the noise::module::Perlin noise module.
	    public static readonly double DEFAULT_PERLIN_PERSISTENCE = 0.5;

	    /// Default noise quality for the noise::module::Perlin noise module.
	    public static readonly NoiseQuality DEFAULT_PERLIN_QUALITY = NoiseQuality.STANDARD;

	    /// Default noise seed for the noise::module::Perlin noise module.
	    public static readonly int DEFAULT_PERLIN_SEED = 0;

	    /// Maximum number of octaves for the noise::module::Perlin noise module.
	    public static readonly int PERLIN_MAX_OCTAVE = 30;
