...
{
    public class TempMenuState : State
    {
        private TempMenuGUI mTempMenuGUI;

        public TempMenuState(StateManager stateMgr) : base(stateMgr) { }

        protected override void Startup()
        {
            this.mTempMenuGUI = new TempMenuGUI(this.mStateMgr.MiyagiManager, "TempMenu GUI");
